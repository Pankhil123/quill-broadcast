              ...
              return (
                <section key={section.id} className="space-y-6">
                  <div className="flex items-center gap-4 pb-3">
                    <h2 className="text-4xl font-extrabold bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent uppercase tracking-wide drop-shadow-sm">
                      {section.name}
                    </h2>
                    <div className="flex-1 h-1 bg-gradient-to-r from-primary/50 via-primary/20 to-transparent rounded-full"></div>
                  </div>
